    ...
    return (
        <div>
            ...
            <div className='bg-customEBF5F3'>
                <div className='container pt-14 pb-14 px-10 md:px-0'>
                    <h2 className='text-xl font-semibold text-zinc-900  mb-5 text-center lg:text-left'>Admission Process</h2>
                    ...
                    {activeSection === 0 && (
                        <div className='mt-5'>
                            <ol className='list-decimal list-inside text-sm'>
                                ...
                                <li>In the Application Form that displays, Select the <strong>Session 2023-24</strong>&nbsp;and fill in all the required details</li>
                                ...
                                <li>Click on the Print button or Save button to print/save the receipt</li>
                            ...
                            <p className='text-sm mt-3'><b>Note: </b>Payment through cheque is not acceptable</p>
                            <div className='flex justify-end mt-8'>
                                <Link href="#" className='text-sm py-1 px-2 text-white rounded bg-custom337AB7 hover:bg-custom286090'>
                                    Enroll Now
                                </Link>
                            </div>
                        </div>
                    ...
                    {activeSection === 1 && (
                        <div className='mt-5 text-sm'>
                            ...
                            <h1 className='text-xl font-bold mb-8'>Walk in Admission</h1>
                            ...
                            <ol className='list-inside list-decimal my-3'>
                                ...
                                <li>The program fee can be paid via Cash/ Demand Draft (DD)/ Online (Debit/Credit Card or UPI)</li>
                                <li>The DD should be made in favour of “<strong>IESMASTER LEARNERS PRIVATE LIMITED</strong>” payable at New Delhi.&nbsp;for Program Fee and in favor of&nbsp;<strong>“IESMASTER PUBLICATION“</strong>&nbsp;for study material (Write your Full Name and Branch of Engineering along with the telephone number on the reverse side of the Demand Draft)<br />
                                    &nbsp;</li>
                                <li>
                                    &nbsp;<strong>NOTE:</strong> Payment through cheque is not acceptable.
                                </li>
                            </ol>
                            <div className='flex justify-end mt-8'>
                                <Link href="#" className='text-sm py-1 px-2 text-white rounded bg-custom337AB7 hover:bg-custom286090'>
            ...
            <div className='container'>
                ...
                <div className='my-12 px-10 md:px-0'>
                    ...
                    <div className='grid grid-cols-2'>
                        <Link href="#" className='ml-3 rounded hover:bg-customE6E6E6 cursor-pointer border w-max py-1 px-2 text-sm'>
                            ESE Toppers
                        </Link>
                        <Link href="#" className='ml-3 rounded hover:bg-customE6E6E6 cursor-pointer border w-max py-1 px-2 text-sm'>
                            ESE Toppers
