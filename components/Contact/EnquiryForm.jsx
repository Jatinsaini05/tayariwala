...
const EnquiryForm = () => {
    ...
    return (
        <div>
            <div style={{ backgroundImage: "url('https://i.filecdn.in/1mlearners/register-shape-1733212771325.jpg')" }} className='p-[35px] rounded'>
                    ...
                    <div className='mt-6'>
                        <label className='flex items-center gap-1 w-max'>
                            ...
                            <span className='text-white'>
                                Accept <Link href="/terms-and-conditions" className='underline'>Terms</Link> And <Link href="/privacy-policy" className='underline'>Privacy Policy.</Link>
                            </span>
                        </label>
