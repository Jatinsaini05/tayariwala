        ...
        <div>
            <div className='md:flex  justify-between py-5 sm:pb-36 items-center lg:gap-32 sm:mx-16 mx-4'>
                <div className='md:w-1/2 text-center md:text-start'>
                    <h1 className='text-custom241737 font-bold sm:text-4xl text-2xl'>{pageData?.heading}</h1>
                ...
                <div className='md:w-1/2'>
                    <div className='relative'>
                        <img src={pageData?.media} alt="Meeting image" className='w-[600px]' />
                        <div className='hidden lg:block'>
                            <img src='https://i.filecdn.in/1mlearners/shape20-1732096402191.png' className='absolute spin bottom-0 right-20 z-[-10]'></img>
                            <img src='https://i.filecdn.in/1mlearners/shape20-1732096402191.png' className='absolute swing bottom-16 left-[-90px] z-[-10]'></img>
                            <img src="https://i.filecdn.in/1mlearners/shape4-1732096425741.png" className='absolute scale top-6 right-0 z-[-10]'></img>
                            <img src="https://i.filecdn.in/1mlearners/shape4-1732096425741.png" className='absolute spin top-[40%] right-10 z-[-10]'></img>
                        </div>
                    </div>
                </div>
            </div>
