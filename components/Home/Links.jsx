            ...
            <div className="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                ...
                <div className="col-span-12 lg:col-span-3 border rounded w-full">
                  <h3 className="text-xl text-[#50b167] font-bold border-b-1 border-black bg-emerald-50 p-2">
                    ...
                    {usefulLink?.contentBlock?.USEFUL_LINK?.advanceData?.data
                      ? usefulLink.contentBlock.USEFUL_LINK.advanceData.data.map(
                          (item, index) => (
                            <li
                              key={index}
                              className="border-b text-sm hover:bg-emerald-50 hover:cursor-pointer items-center gap-2 px-2 py-1 flex"
                            >
                              <FaBook className="text-lg flex-shrink-0" />{" "}
                              {/* Icon ke size ko fix kiya */}
                ...
                <div className="col-span-12 lg:col-span-9 flex flex-col gap-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-7">
                    <div className=" relative border rounded">
                      <a href="#">
                        <h3 className="text-lg text-[#50b167] font-bold border-b-1 border-black bg-emerald-50 p-2">
                          <HiMiniVideoCamera className="mr-1 inline" />
                      ...
                      <div className="flex justify-center items-center p-2">
                        ...
                        {usefulLink?.contentBlock?.HOME_VIDEO1?.link && (
                          <Link
                            href={usefulLink?.contentBlock?.HOME_VIDEO1?.link}
                            className="absolute z-10 text-[11px] text-green-700 px-2 bg-gray-200 hover:text-gray-200 hover:bg-green-700 py-1 transform translate-y-1/2 right-0 bottom-3"
                          >
                            View More &gt;
                          </Link>
                        )}
                  ...
                  <div className="border rounded flex flex-col">
                    <h3 className="text-emerald-600 text-lg font-medium border-b-1 border-black bg-emerald-50 p-2">
                      <Link
                        href={usefulLink?.contentBlock?.ESE_2023_TOPPERS?.link}
                    ...
                    <div className="relative p-2">
                      ...
                      {usefulLink?.contentBlock?.ESE_2023_TOPPERS?.link && (
                        <Link
                          href={
                            usefulLink?.contentBlock?.ESE_2023_TOPPERS?.link
                          }
                  ...
                  <div className="border rounded flex flex-col">
                    <h3 className="text-emerald-600 text-lg font-medium border-b-1 border-black bg-emerald-50 p-2">
                      <Link
                        href={usefulLink?.contentBlock?.GATE_TOPPERS?.link}
                        className="flex items-center"
                      >
                        <IoIosPeople className="mr-1" />
                    ...
                    <div className="relative p-2">
                      ...
                      >
                        {usefulLink?.contentBlock?.GATE_TOPPERS?.advanceData
                          ?.data
                          ? usefulLink.contentBlock.GATE_TOPPERS.advanceData.data.map(
                              (itm, ind) => (
                                <SwiperSlide key={ind}>
                                  <img
                                    className="border"
                      ...
                      {usefulLink?.contentBlock?.GATE_TOPPERS?.link && (
                        <Link
                          href={usefulLink?.contentBlock?.GATE_TOPPERS?.link}
                          className="absolute z-10 text-[11px]  px-2 bg-green-700 text-white  py-1 transform translate-y-1/2 right-0 bottom-3"
                        >
