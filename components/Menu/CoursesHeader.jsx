...
export default function CoursesHeader() {
  ...
  return (
    <>
      {visible && ( // Header becomes visible when the state is true
        <div className="fixed top-0 shadow-lg w-full bg-white z-30 overflow-x-auto transition-opacity duration-300">
          <ul className="flex justify-center text-[#221638] sm:text-base text-xs shadow-[2px_10px_15px_6px_rgba(0,0,0,0.1)]">
            <li>
              <Link
                href="#exam-info"
