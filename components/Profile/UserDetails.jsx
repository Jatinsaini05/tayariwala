...
import {
  getUserBookData,
  getUserLiveClassData,
  getUserOfflineScheduleData,
  getUserOrderData,
  getUserProductData,
  getUserQuizData,
  getUserQuizGroup,
  getUserTestSeriesData,
      ...
      <div className="lg:grid lg:grid-cols-12 px-3 lg:px-0">
          ...
          <div className="flex border lg:flex-col">
            ...
            >
              <span className="flex items-center gap-4">
                <FaVideo
                  className={`${active === "courses" ? "text-white" : "text-customFC6200 group-hover:text-white"}`}
                />
                <span>Courses</span>
              </span>
              <span>
                <MdOutlineKeyboardArrowRight
                  className={`hidden lg:block ${active === "courses" ? "rotate-180 text-white" : "text-[#999] group-hover:text-white"}`}
                />
              </span>
            </button>
            ...
            >
              <span className="flex items-center gap-4">
                <FaClipboardList
                  className={`${active === "orders" ? "text-white" : "text-customFC6200 group-hover:text-white"}`}
                />
                <span>Orders</span>
              </span>
              <span>
                <MdOutlineKeyboardArrowRight
                  className={`hidden lg:block ${active === "orders" ? "rotate-180 text-white" : "text-[#999] group-hover:text-white"}`}
                />
              </span>
            </button>
            ...
            <button
              ...
              onClick={() => {
                setActive("liveclasses");
                fetchLiveClassData();
              }}
            >
              <span className="flex items-center gap-4">
                <FaVideo
                  className={`${active === "liveclasses" ? "text-white" : "text-customFC6200 group-hover:text-white"}`}
                />
                <span className="w-32 lg:w-auto">Live Classes</span>
              </span>
              <span>
                <MdOutlineKeyboardArrowRight
                  className={`hidden lg:block ${active === "liveclasses" ? "rotate-180 text-white" : "text-[#999] group-hover:text-white"}`}
                />
              </span>
            </button>
            ...
            <button
              ...
              onClick={() => {
                setActive("offlineschedule");
                fetchOfflineScheduleData();
              }}
            >
              <span className="flex items-center gap-4">
                <MdOutlineSchedule
                  className={`${active === "offlineschedule" ? "text-white" : "text-customFC6200 group-hover:text-white"}`}
                />
                <span className="w-32 lg:w-auto">Offline Schedule</span>
              </span>
              <span>
                <MdOutlineKeyboardArrowRight
                  className={`hidden lg:block ${active === "offlineschedule" ? "rotate-180 text-white" : "text-[#999] group-hover:text-white"}`}
                />
              </span>
            </button>
            ...
            <button
              ...
              onClick={() => {
                setActive("tests"), fetchTestSeriesData();
              }}
            >
              <span className="flex items-center gap-4">
                <GiNotebook
                  className={`${active === "tests" ? "text-white" : "text-customFC6200 group-hover:text-white"}`}
                />
                <span>Tests</span>
              </span>
              <span>
                <MdOutlineKeyboardArrowRight
                  className={`hidden lg:block ${active === "tests" ? "rotate-180 text-white" : "text-[#999] group-hover:text-white"}`}
                />
              </span>
            </button>

            {user?.productCategories?.includes("5b267b05851670048a6820a9") && (
              <Link href="https://maheshpratap.institute.org.in/student/conventional-exam">
                <button className="flex border-r group border-b w-full items-center justify-between md:p-5 p-2 text-sm hover:bg-customFC6200 hover:text-white">
                  <span className="flex items-center gap-4">
                    <CiPen
                      className={`${active === "conventional" ? "text-white" : "text-customFC6200 group-hover:text-white"}`}
                    />
            ...
            >
              <span className="flex items-center gap-4">
                <FaPuzzlePiece
                  className={`${active === "quiz" ? "text-white" : "text-customFC6200 group-hover:text-white"}`}
                />
                <span>Quiz</span>
              </span>
              <span>
                <MdOutlineKeyboardArrowRight
                  className={`hidden lg:block ${active === "quiz" ? "rotate-180 text-white" : "text-[#999] group-hover:text-white"}`}
                />
              </span>
            </button>
            ...
            >
              <span className="flex items-center gap-4">
                <FaBook
                  className={`${active === "books" ? "text-white" : "text-customFC6200 group-hover:text-white"}`}
                />
                <span>Books</span>
              </span>
              <span>
                <MdOutlineKeyboardArrowRight
                  className={`hidden lg:block ${active === "books" ? "rotate-180 text-white" : "text-[#999] group-hover:text-white"}`}
                />
              </span>
            </button>
            ...
            <button
              onClick={data}
              className="flex group border-b border-r w-full items-center justify-between md:p-5 p-2 text-sm hover:bg-customFC6200 hover:text-white"
            >
              <span className="flex items-center gap-4">
        ...
        <div className="pt-6 md:pr-6 md:col-span-8 xl:col-span-9 w-full">
          <div className="">
            {active === "courses" && (
              <div>
                <Courses userData={courseData} />
              </div>
            )}
            {active === "orders" && (
              <div>
                <Orders userData={orderData} />
              </div>
            )}
            {active === "liveclasses" && (
              <div>
                <LiveClasses userData={liveClassData} />
              </div>
            )}
            {active === "offlineschedule" && (
              <div>
                <OfflineSch userData={offlineSchData} />
              </div>
            )}
            {active === "tests" && (
              <div>
                <Tests userData={testData} />
              </div>
            )}
            {active === "quiz" && (
              <div>
                <Quiz userData={quizData} user={user} />
              </div>
            )}
            {active === "books" && (
              <div>
                <Books userData={bookData} />
              </div>
            )}
          </div>
        </div>
