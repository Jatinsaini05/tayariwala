...
export default function Admission() {
  ...
  return (
    <div>
      <section className="py-[2rem] px-[10px] lg:px-[2rem]  sm:py-[3rem] ">
              ...
              <div className="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-12 lg:px-2.5">
                ...
                {activeIndex == 0 && (
                  <div className="mt-[1rem]">
                    <h2 className="text-[20px] font-semibold text-left border-b-1 border-solid border-[lightgray] pb-[2rem] ">
                      Online Admission
                    </h2>
                    <h3 className="text-[14px] mt-[1rem]">
