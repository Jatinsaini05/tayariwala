...
export default function Admission({ adm }) {
  const listId = adm?.programData?.more?.list;
          ...
          <div className="grid grid-rows">
            <div className="grid grid-cols-12">
              <div className="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-12 lg:px-2.5">
                <h2 className="text-[22px] font-semibold text-center sm:text-left">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: adm?.programData?.more?.content,
                    }}
                  />
                </h2>
