...
export default function CoursesHeader() {
  ...
  const handleScroll = () => {
    const sections = ["exam-info", "syllabus", "live-classes", "offline-classes", "test-series", "study-material"];
    let currentSection = "";
    ...
    <>
      {visible && ( 
        <div className="fixed top-0 bg-white w-full z-30 transition-opacity duration-300 shadow-[2px_10px_15px_6px_rgba(0,0,0,0.1)]">
          <ul className="flex md:justify-center w-full overflow-auto text-[#221638] sm:text-base text-xs">
            <li>
              <Link
                href="#exam-info"
