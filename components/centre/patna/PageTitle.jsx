                ...
                <div className='container'>
                    <div className='xl:px-[200px]'>
                        <h2 className='font-extrabold mb-[10px] sm:text-4xl text-[26px] text-center'>
                            Best offline coaching For SSC-JE, STATE-AE/JE, STATE-PSCs and other engineering exams in Patna                    </h2>
                    </div>
                    <ul className="flex justify-center items-center gap-6 text-sm sm:text-base">
                        ...
                        <li className="text-[#221638]">
                            Best offline coaching For SSC-JE, STATE-AE/JE, STATE-PSCs and other engineering exams in Patna                        </li>
                    </ul>
