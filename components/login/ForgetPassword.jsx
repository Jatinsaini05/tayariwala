        ...
        <div className="col-12 rounded-[8px] p-0 shadow-[0_8px_6px_-1px_rgba(0,0,0,0.2),0_8px_8px_0_rgba(0,0,0,0.14),0_8px_8px_0_rgba(0,0,0,0.12)]">
          ...
          {page === 1 ? (
            <div className="flex flex-col justify-center px-5">
              ...
              {/* <div className="flex justify-content-center sm:justify-content-start">
                <button
                  className="border-none text-white bg-green-400 text-sm cursor-pointer px-5 py-1 border-round-sm mt-4"
                  label="Submit"
            ...
            <div className="col-12 flex flex-col justify-content-center px-5">
              ...
              <div className="mt-[10px]">
                <div>
                  <label className="text-[15px] font-bold flex gap-[2px]">
                    Confirm Password: <p className="p-0 m-0 text-red-500">*</p>
                  </label>
                </div>
                <input
                  type="password"
