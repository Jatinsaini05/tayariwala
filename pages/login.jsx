  ...
  const handleLogin = async () => {
    ...
    if (validate()) {
      try {
        ...
        console.log("Error", err.message || "An unknown error occurred"); 
        useStoreSnackbar.getState().showSnackbar({
            ...
            {page == 1 && (
              <div className="block mt-[2rem] mb-[2rem] mx-auto w-[100%] rounded-[8px] sm:w-[70%]  lg:w-[60%] cl:w-[50%] shadow-[0_8px_6px_-1px_rgba(0,0,0,0.2),0_8px_8px_0_rgba(0,0,0,0.14),0_8px_8px_0_rgba(0,0,0,0.12)] pb-[1rem]">
                ...
                <div className="col-12 flex flex-col justify-center px-5">
                  ...
                  <div className="flex justify-end gap-[8px] items-center pt-3 pb-2 text-xs lg:text-sm text-600">
                    Don&apos;t have an account?
                    <Link
                      href="/register"
                      className="text-white bg-[#071e63] text-[14px] rounded-[6px] cursor-pointer px-6 pt-1 pb-2"
                    >
                      Register
                    </Link>
                    <Link
